# Aggregators API Service MCP Server

This MCP (Model Content Protocol) server provides access to Aggregators API Service API functionality through HTTP, HTTPS, and STDIO transport modes.
